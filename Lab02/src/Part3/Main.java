...
public class Main {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Country nameHighestCH4 = Country.countryWithHighestCH4InYear(countries, 2000);
        double highestCh4 = Country.countryWithHighestCH4InYear(countries,2000).getEmissions().get(2000).getCH4();

        Country nameHighestIncrease = Country.countryWithHighestChangeInEmissions(countries, 1988, 2012);
        double highestIncrease = (nameHighestIncrease.getEmissions().get(2012).getCH4() + nameHighestIncrease.getEmissions().get(2012).getN2O() + nameHighestIncrease.getEmissions().get(2012).getCO2()) -
                                 (nameHighestIncrease.getEmissions().get(1988).getCH4() + nameHighestIncrease.getEmissions().get(1988).getN2O() + nameHighestIncrease.getEmissions().get(1988).getCO2());

        Sector sectorNameIncrease = Sector.sectorWithBiggestChangeInEmissions(sectors,1988,2012);
        ...
        System.out.println();
        System.out.println("Country with highest methane gas emission in 2000: " + nameHighestCH4.getName() + " with " + highestCh4 );
        System.out.println("Country with highest increase in greenhouse gas emissions between 1988 and 2012: " + nameHighestIncrease.getName()  + " with " + highestIncrease);
        System.out.println("Sector with the highest change in greenhouse gas emissions between 1988 and 2012: " + sectorNameIncrease.getName()  + " with " +sectorIncrease);
    }
